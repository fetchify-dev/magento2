...
function cc_rapid(cfg) {
	...
	if (typeof this.geocode == 'undefined') this.geocode = false;
	this.alias = cfg.alias;
	if (typeof this.alias == 'undefined') this.alias = false;
	this.preformat = cfg.preformat;
	if (typeof this.preformat == 'undefined') this.preformat = false;
